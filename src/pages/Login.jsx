      ...
      <section class="h-screen">
        <div class="h-full">
          <div class="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
            <div class="shrink-1 mb-12 grow-0 basis-auto md:mb-0 md:w-9/12 md:shrink-0 lg:w-6/12 xl:w-6/12 bg-white p-7 rounded-lg flex justify-center">
              <form>
                ...
                <div class="mb-6 flex items-center justify-between">
                  ...
                  <div class="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                    ...
                    />
                    <label
                      class="inline-block pl-[0.15rem] hover:cursor-pointer text-neutral-900"
                      for="exampleCheck2"
                    >
                      Remember me
                    </label>
                ...
                <div class="text-center lg:text-left">
                  ...
                  {/* <!-- Register link --> */}
                  <p class="mb-0 mt-2 pt-1 text-sm font-semibold text-neutral-900">
            ...
            <div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12 ">
              <img src="src/assets/bg1.png" class="w-full" alt="Sample image" />
            </div>
          </div>
        </div>
      </section>
